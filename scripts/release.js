...
async function release() {
  ...
  rl.question('What type of release? (patch/minor/major) [patch]: ', (releaseType) => {
    ...
    exec(`git flow release finish ${newVersion} -m "Release ${newVersion}"`);
    exec(`git tag v${newVersion} -m "Release ${newVersion}"`);
    ...
    console.log(`  git push origin master develop ${tagName} --tags`);
